...
::: footer
Learn more: [Slide Backgrounds](https://quarto.org/docs/presentations/revealjs/#slide-backgrounds)
:::
...
##  {background-image="20210601_biogas.jpg" background-size="contain" background-repeat="no-repeat" background-position="left"}
...
::: {.column width="55%"}
#### Image left using Quarto

This is a slide where an image is in the background to the left.

``` quarto
##  {background-image="imageName.jpg" background-size="contain" background-repeat="no-repeat" background-position="left"}
```
:::
:::

::: {.footer style="text-align: right; margin-left: 45%; right: 20%"}
Learn more: [Slide Backgrounds](https://quarto.org/docs/presentations/revealjs/#slide-backgrounds)
:::
...
![](imageName.jpg){.image-left}
```
:::
:::

![](20210601_biogas.jpg){.image-left}

::: {.footer style="text-align: right; margin-left: 45%; right: 20%"}
Learn more: [Slide Backgrounds](https://quarto.org/docs/presentations/revealjs/#slide-backgrounds)
:::

##  {background-image="20190214_glass-bottles_vertical.jpg" background-size="contain" background-repeat="no-repeat" background-position="right"}

::: columns
::: {.column width="60%"}
#### Image right using Quarto

This is a slide where an image is in the background to the right.

``` quarto
##  {background-image="image-name.jpg" background-size="contain" background-repeat="no-repeat" background-position="right"}
```
:::
...
You can hide a slide by adding the visibility="hidden" attribute to the slide heading.
...
To "hide" slides from then numbering system you can use `visibility="uncounted"`.
...
![](https://quarto.org/docs/presentations/revealjs/demo/images/speaker-view.png){fig-align="center" width="1500"}
...
Quarto^®^ is an open-source scientific and technical publishing system built on Pandoc[@quartoa].

Include the `refernces.bib` file into the folder.
...
## Standard Footer {style=".smaller"}

The standard footer is set in the YAML header
...
Include a individual footer for each slide including the footer attribute.
